package com.yulin.recyclerviewpager.rvp;
...
import com.yulin.recyclerviewpager.BuildConfig;
import com.yulin.recyclerviewpager.R;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    protected void adjustPositionX(int velocityX) {
        ...
        if (childCount > 0) {
            ...
            int flingCount = getFlingCount(velocityX);
    ...
    protected void adjustPositionY(int velocityY) {
        ...
        if (childCount > 0) {
            ...
            int flingCount = getFlingCount(velocityY);
    ...
    private int getFlingCount(int velocity) {
        if (velocity == 0) {
            return 0;
        }
